...
**Base URL:** `https://crm-enhancement-10.preview.emergentagent.com`  
**Version:** v1  
...
curl -H "X-API-Key: oll_sk_your_key_here" \
  "https://crm-enhancement-10.preview.emergentagent.com/api/external/schools/active"
```
...
curl -H "X-API-Key: oll_sk_your_key_here" \
  "https://crm-enhancement-10.preview.emergentagent.com/api/external/schools?status=active&limit=50"

# Paginate — next page
curl -H "X-API-Key: oll_sk_your_key_here" \
  "https://crm-enhancement-10.preview.emergentagent.com/api/external/schools?status=active&limit=50&offset=50"
```
...
```bash
curl -H "X-API-Key: oll_sk_your_key_here" \
  "https://crm-enhancement-10.preview.emergentagent.com/api/external/schools/09dcd297-f09a-4f16-a8eb-e52747b8d46c"
```
...
```bash
curl -H "X-API-Key: oll_sk_your_key_here" \
  "https://crm-enhancement-10.preview.emergentagent.com/api/external/schools/stats/summary"
```
...
BASE_URL = "https://crm-enhancement-10.preview.emergentagent.com"
...
```javascript
const BASE_URL = "https://crm-enhancement-10.preview.emergentagent.com";
