...
// Google Search "Top" tab was showing the same homepage thumbnail for every
// OLL result because every route shared `og-default.png`. Mapping by topic
// gives each page family a visually distinct preview (robotics build photos
// for /courses/robotics, the camp poster for /summer-camp, etc.) so social
// previews and SERP image carousels no longer look like duplicates.
const OG = {
  default:        DEFAULT_OG_IMAGE,
  robotics:       ogImage('https://customer-assets.emergentagent.com/job_fb8cd4bf-3b7a-429f-a2a5-3e03f993cb50/artifacts/h11kmu1i_20260504_122503.jpg'),
  roboticsKit:    ogImage('https://customer-assets.emergentagent.com/job_fb8cd4bf-3b7a-429f-a2a5-3e03f993cb50/artifacts/gwljm6r9_20260504_122607.jpg'),
  roboticsBuild:  ogImage('https://customer-assets.emergentagent.com/job_fb8cd4bf-3b7a-429f-a2a5-3e03f993cb50/artifacts/tqatbciw_20260504_124243.jpg'),
  roboticsClass:  ogImage('https://customer-assets.emergentagent.com/job_fb8cd4bf-3b7a-429f-a2a5-3e03f993cb50/artifacts/ctig02to_IMG-20260504-WA0020.jpg'),
  roboticsCrew:   ogImage('https://customer-assets.emergentagent.com/job_fb8cd4bf-3b7a-429f-a2a5-3e03f993cb50/artifacts/rhwyg94z_20260504_163950.jpg'),
  ai:             ogImage('https://customer-assets.emergentagent.com/job_fb8cd4bf-3b7a-429f-a2a5-3e03f993cb50/artifacts/gs8rqk64_ChatGPT%20Image%20Jun%204%2C%202026%2C%2012_57_50%20PM.png'),
  coding:         ogImage('https://customer-assets.emergentagent.com/job_fb8cd4bf-3b7a-429f-a2a5-3e03f993cb50/artifacts/guo8nycx_ChatGPT%20Image%20Jun%204%2C%202026%2C%2012_52_07%20PM.png'),
  financial:      ogImage('https://customer-assets.emergentagent.com/job_fb8cd4bf-3b7a-429f-a2a5-3e03f993cb50/artifacts/yor077gl_ChatGPT%20Image%20Jun%204%2C%202026%2C%2001_00_05%20PM.png'),
  entrepreneur:   ogImage('https://customer-assets.emergentagent.com/job_fb8cd4bf-3b7a-429f-a2a5-3e03f993cb50/artifacts/wus3ar3y_1.png'),
  threeD:         ogImage('https://customer-assets.emergentagent.com/job_fb8cd4bf-3b7a-429f-a2a5-3e03f993cb50/artifacts/y01nt59y_2.png'),
  summerCamp:     ogImage('https://customer-assets.emergentagent.com/job_fb8cd4bf-3b7a-429f-a2a5-3e03f993cb50/artifacts/x3ipatnb_Summer%20Camp%20Poster%202026%20%20%28A3%29.png'),
  fathersDay:     ogImage('https://customer-assets.emergentagent.com/job_fb8cd4bf-3b7a-429f-a2a5-3e03f993cb50/artifacts/2t1vu6l9_ChatGPT%20Image%20Jun%204%2C%202026%2C%2012_50_47%20PM.png'),
  school:         ogImage('https://customer-assets.emergentagent.com/job_bd46440b-dd5c-4da0-88ea-ad65b8f91d70/artifacts/ko80g3wd_images.png'),
  kbcShark:       ogImage('https://customer-assets.emergentagent.com/job_bd46440b-dd5c-4da0-88ea-ad65b8f91d70/artifacts/mkbfftaz_KBC%20Website%20%281%29.png'),
  about:          ogImage('https://customer-assets.emergentagent.com/job_bd46440b-dd5c-4da0-88ea-ad65b8f91d70/artifacts/1a3c9g9x_KBC%20%26%20Shark%20Tank%20Website.png'),
  workshop:       ogImage('https://customer-assets.emergentagent.com/job_fb8cd4bf-3b7a-429f-a2a5-3e03f993cb50/artifacts/580sl54n_3.png'),
  futureSkills:   ogImage('https://customer-assets.emergentagent.com/job_fb8cd4bf-3b7a-429f-a2a5-3e03f993cb50/artifacts/tg3vboqf_4.png'),
};
...
const ROUTES = {
  '/': {
    ...
    description: "India's leading future-skills platform for kids 4-16. Live Robotics, AI, Coding, Entrepreneurship & Financial Literacy classes. 500+ schools trust OLL.",
  ...
  '/about': {
    ...
    description: 'Meet OLL — India\'s future-skills education platform for kids 4-16. Featured on Shark Tank India and KBC. 500+ schools served nationwide.',
  ...
  '/offerings': {
    ...
    description: 'Explore OLL\'s catalogue of live skill classes & in-school programs: Robotics, AI, Coding, Entrepreneurship and Financial Literacy for ages 4-16.',
  ...
  '/centers': {
    ...
    ogImage: OG.roboticsClass,
    ogType: 'website',
  },

  '/for-schools': {
    title: 'OLL for Schools — Robotics Labs, AI Centres & Coding Programs',
    description: 'Turn your school into a future-skills hub. OLL Robotics Labs, AI Centres, Coding & Entrepreneurship programs run in 500+ schools across India.',
  ...
  '/summer-camp': {
    ...
    ogImage: OG.summerCamp,
    ogType: 'website',
  },

  '/ai-foundations': {
    title: 'AI Foundations — Live AI Course for Teens age 11-16 | OLL',
    description: 'Live cohort-based AI Foundations course for teens 11-16. Build real AI projects, learn LLMs, agents and prompt engineering with OLL\'s educators.',
  ...
  '/social-media-intern': {
    ...
    ogImage: OG.entrepreneur,
    ogType: 'website',
  },

  '/growth-partner': {
    title: 'OLL Growth Partner Program — Earn While Spreading Future Skills',
    description: 'Become an OLL Growth Partner — partner with India\'s leading future-skills brand and earn while bringing Robotics, AI & Coding to your community.',
...
const SUMMER_CAMP_SKILLS = [
  { slug: 'robotics', label: 'Robotics', og: OG.robotics },
  { slug: 'coding', label: 'Coding', og: OG.coding },
  { slug: 'ai', label: 'AI', og: OG.ai },
  { slug: '3d-design', label: '3D Design', og: OG.threeD },
  { slug: 'financial-literacy', label: 'Financial Literacy', og: OG.financial },
  { slug: 'entrepreneurship', label: 'Entrepreneurship', og: OG.entrepreneur },
];
SUMMER_CAMP_SKILLS.forEach(({ slug, label, og }) => {
...
const COURSES = [
  { slug: 'robotics', label: 'Robotics', desc: 'Live Robotics classes for kids age 4-16 — build real robots, learn microcontrollers & programming with OLL trained educators.', og: OG.robotics },
  { slug: 'coding', label: 'Coding', desc: 'Live Coding classes for kids age 4-16 — Scratch, Python, JavaScript & full-stack web with OLL trained educators.', og: OG.coding },
  { slug: 'ai', label: 'AI', desc: 'Live AI classes for kids age 8-16 — build AI projects, learn LLMs, prompt engineering & ML fundamentals with OLL educators.', og: OG.ai },
  { slug: 'financial', label: 'Financial Literacy', desc: 'Live Financial Literacy for kids age 8-16 — money sense, budgeting, investing & entrepreneurship with OLL educators.', og: OG.financial },
  { slug: 'entrepreneurship', label: 'Entrepreneurship', desc: 'Live Entrepreneurship for kids age 10-16 — idea, build, pitch & sell with OLL educators and real mentors.', og: OG.entrepreneur },
];
ROUTES['/courses'] = {
...
COURSES.forEach(({ slug, label, desc, og }) => {
  ROUTES[`/courses/${slug}`] = {
...
const SCHOOL_OFFERINGS = [
  { cat: 'robotics', slug: 'robotics-lab-setup', label: 'Robotics Lab Setup', desc: 'Turn-key Robotics Lab setup for schools — equipment, curriculum, teacher training & ongoing support from OLL.', og: OG.roboticsKit },
  { cat: 'robotics', slug: 'robotics-curriculum-kits', label: 'Robotics Curriculum & Kits', desc: 'Age-graded Robotics curriculum + student kits for schools — Grades 1-10, mapped to NEP 2020.', og: OG.roboticsBuild },
  { cat: 'robotics', slug: 'robotics-afterschool', label: 'Robotics After-School Program', desc: 'After-school Robotics program delivered by OLL educators on campus — Grades 1-10.', og: OG.roboticsClass },
  { cat: 'ai', slug: 'ai-center-excellence', label: 'AI Centre of Excellence', desc: 'AI Centre of Excellence for schools — full curriculum, infra, teacher upskilling & student showcase.', og: OG.ai },
  { cat: 'ai', slug: 'ai-foundations', label: 'AI Foundations for Schools', desc: 'Cohort-based AI Foundations curriculum for school students — taught by OLL AI educators.', og: OG.ai },
  { cat: 'coding', slug: 'python-curriculum', label: 'Python Curriculum', desc: 'Grade-wise Python curriculum for schools — Grades 6-10, project-based, mapped to CBSE & ICSE.', og: OG.coding },
  { cat: 'coding', slug: 'coding-afterschool', label: 'Coding After-School Program', desc: 'After-school coding program for schools — Scratch, Python & web development for Grades 1-10.', og: OG.coding },
  { cat: 'financial-literacy', slug: 'financial-bootcamp', label: 'Financial Literacy Bootcamp', desc: 'Financial Literacy bootcamp for school students — money sense, budgeting & investing fundamentals.', og: OG.financial },
  { cat: 'financial-literacy', slug: 'entrepreneurship-workshop', label: 'Entrepreneurship Workshop', desc: 'Hands-on Entrepreneurship workshop for school students — idea, build, pitch & sell, with real mentors.', og: OG.entrepreneur },
];
...
SCHOOL_OFFERINGS.forEach(({ cat, slug, label, desc, og }) => {
