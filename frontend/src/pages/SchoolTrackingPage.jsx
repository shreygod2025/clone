...
// Helper to build a backend-proxied URL for an uploaded file.
...
// Download file utility — uses backend proxy for proper Content-Type & filename.
...
const STEP_ICONS = {
  ...
  lab_setup: <Building2 className="w-5 h-5" />,
  lab_refilling: <Package className="w-5 h-5" />,
  technical_check: <Settings className="w-5 h-5" />,
  teacher_training: <BookOpen className="w-5 h-5" />,
  teacher_allocation: <User className="w-5 h-5" />,
  teacher_approval: <ThumbsUp className="w-5 h-5" />,
