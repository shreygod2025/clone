    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50/40 to-white" data-testid="future-skills-success">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="bg-white border-2 border-slate-100 rounded-3xl p-8 lg:p-12 shadow-2xl shadow-blue-100/50 text-center">
          {status === 'verifying' && (
            <>
              <Loader2 className="w-16 h-16 mx-auto mb-4 text-[#1E3A5F] animate-spin" />
          ...
          {status === 'paid' && (
            <>
              <div className="w-20 h-20 mx-auto mb-5 rounded-full bg-gradient-to-br from-red-50 to-blue-50 border border-blue-100 flex items-center justify-center">
              ...
              <div className="mt-8 bg-gradient-to-br from-red-50/60 to-blue-50/60 border border-blue-100 rounded-2xl p-5 text-left text-sm text-slate-700 space-y-2">
              ...
              {isTrial && (
                <div className="mt-10 text-left bg-gradient-to-br from-[#D63031] via-[#7B2C5C] to-[#1E3A5F] text-white rounded-3xl p-6 lg:p-8 relative overflow-hidden" data-testid="success-soft-pitch">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-[11px] text-white/80 mt-3">No pressure — your free trial is fully booked either way.</p>
                  </div>
                </div>
              )}
            </>
          ...
          {status === 'pending' && (
            <>
              <Loader2 className="w-14 h-14 mx-auto mb-4 text-[#D63031] animate-spin" />
          ...
          {status === 'error' && (
            <>
              <AlertCircle className="w-14 h-14 mx-auto mb-4 text-[#D63031]" />
