...
export const COURSES = {
  ...
  ai: {
    ...
    metaTitle: 'AI Classes for Kids | OLL - Learn Machine Learning',
    metaDescription: 'Discover AI & Machine Learning at OLL! Perfect for ages 12-17. Build AI projects, understand neural networks, create chatbots. Book your free demo class!',
  ...
  entrepreneurship: {
    ...
    metaTitle: 'Entrepreneurship for Kids | OLL - Young Entrepreneur Program',
    metaDescription: 'OLL\'s Young Entrepreneur Program for ages 10-17. Learn business basics, pitch ideas, build startups. Develop leadership & innovation skills. Book free demo!',
