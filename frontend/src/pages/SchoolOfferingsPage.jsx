          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap justify-center gap-2 md:gap-4 mb-12">
              {partnerSchools.map((school, idx) => (
                <div 
                  key={idx}
                  className="px-4 py-2 md:px-6 md:py-3 bg-white/10 backdrop-blur-sm rounded-full text-white text-xs md:text-sm"
                >
                  <School className="w-3 h-3 md:w-4 md:h-4 inline mr-1 md:mr-2" />
