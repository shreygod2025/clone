...
const BlogDetailPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <Helmet>
        <title>{blog.title} | OLL Blog - Skill Education Insights</title>
        <meta name="description" content={blog.excerpt || `Read ${blog.title} on the OLL Blog. Expert insights on robotics, coding, AI, and skill education for students, parents, and educators.`} />
      </Helmet>
      {/* Header */}
